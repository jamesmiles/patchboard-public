...
.patchboard/
  ...
  docs/                     Project documentation
    technical-docs/    Architecture docs, ADRs, design decisions
...
| `planner` | Decomposes goals into tasks, manages roadmap |
| `tester` | Conducts visual testing of PR functionality |
